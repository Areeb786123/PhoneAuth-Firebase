...
import kotlinx.android.synthetic.main.activity_otp_activity.*
...
class otp_activity : AppCompatActivity() {
    ...
    val otpEt by lazy {
        findViewById<TextView>(R.id.enter_otp)
    }
    val verificationBtn by lazy {
        findViewById<Button>(R.id.send_otp)
    }
    val resendBtn by lazy {
        findViewById<Button>(R.id.resend_otp)
    }
